namespace Travel {
  ...
  export function init({ targetIsland }: { targetIsland: Map.Island }) {
    ...
    animation.runImageAnimation(_videoSprite, _startAnimation, 500, true);
    ...
    if (result > Math.randomRange(0, 100)) {
      animation.runImageAnimation(_videoSprite, _pirateAnimation, 500, false);
      ...
      animation.runImageAnimation(_videoSprite, _islandAnimation, 500, false);
