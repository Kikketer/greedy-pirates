namespace Island {
  ...
  function openTreasure() {
    ...
    if (!_treasureOpened) {
      ...
      animation.runImageAnimation(_treasureSprite, openTreasureAnimation, 200, false);
      setTimeout(() => {
  ...
  export function init({ island }: { island: Map.Island }) {
    ...
    player1 = new Pirate({
      ...
      onDie: onPirateDeath,
      boundaries: _boundingBox,
      statLocation: player1StatLocation,
    });
    player2 = new Pirate({
      ...
      onDie: onPirateDeath,
      boundaries: _boundingBox,
      statLocation: player2StatLocation,
    });
  ...
  export function render() {
    ...
    if (
      isSegmentComplete &&
      (player1.sprite.x > 150 || player2.sprite.x > 150) &&
      currentSegment < _island.segments - 1
    ) {
