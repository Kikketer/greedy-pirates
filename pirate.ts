...
class Pirate {
  ...
  static deathSound: music.SoundEffect = music.createSoundEffect(
    WaveShape.Triangle,
    2202,
    476,
    129,
  ...
  static hitSound: music.SoundEffect = music.createSoundEffect(
    WaveShape.Noise,
    462,
    1,
    150,
  ...
  private attack(attackCallback: (T: AttackCallbackParams) => void) {
    ...
    if (this.facing === "right") {
      ...
      // }
      animation.runImageAnimation(this.sprite, this.attackRightAnimation, 50, false);
      ...
      attackCallback({ pirate: this });
      animation.runImageAnimation(this.sprite, this.attackLeftAnimation, 50, false);
      // And reset the sprite so it can no longer hit something
      setTimeout(() => {
        this.isAttacking = undefined;
